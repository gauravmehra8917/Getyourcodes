    ...
    <div className="mx-auto max-w-md px-4 py-12 sm:py-16">
      ...
      {sent ? (
        <div className="mt-8 space-y-4">
          ...
          <button onClick={() => navigate({ to: "/auth", search: {} })} className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          ...
          <Link to="/auth" search={{}} className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
            <ArrowLeft className="h-4 w-4" /> Back to sign in
          </Link>
        </form>
      )}
