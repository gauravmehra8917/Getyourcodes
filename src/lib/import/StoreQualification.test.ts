...
const plan = (coupons: PlannedRecord<any>[], deals: PlannedRecord<any>[] = []): ImportPlan => ({ provider: "test", integrationId: "test", createdAt: "", storesToCreate: [], storesToUpdate: [], storeCandidates: [], storeLifecycle: [], storeLifecycleStatistics: { storesEvaluated: 0, storesQualified: 0, storesHeld: 0, storesToCreate: 0, storesToUpdate: 0, storesToLifecycleHide: 0, storesToLifecycleRepublish: 0 }, couponsToCreate: coupons, couponsToUpdate: [], dealsToCreate: deals, dealsToUpdate: [], categoriesToCreate: [], categoriesToUpdate: [], skipped: [], validationErrors: [], conflicts: [], warnings: [], identity: [] });
